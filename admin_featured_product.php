 ...
 ?>
   ...
   <div class="top container">
          ...
          <form action ="add_fproduct.php" method="POST">
          <button type="submit" name ="Add_featured_product" class="login_btn"> <h3>Add Product</h3></button> 
          </form>
      </div>
      <?php 
       $limit = 7;
       ...
       $offset = ($page-1)* $limit;
        $sql = "SELECT*FROM featured  LIMIT {$offset},{$limit}";
      ...
      <table>
            ...
            <?php
             ...
             <!--    <td>null</td>-->
             <td><a href ="delete-data.php?featured-id=<?php echo $row['id'] ?>"><i class="far fa-trash-alt"></i></a></td>
              </tr>
            <?php } ?>
          ...
          echo ' <div class=" container">';
           ...
           for($i=1;  $i<=$tolal_page; $i++) {
              ...
              echo '  <span class=" '.$active.'">
                <a href="admin_featured_product.php?page='.$i.'">'.$i.'</a>
          </span>'; 
           }
