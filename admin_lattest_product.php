 ...
 ?>
   ...
   <div class="top container">
          ...
          <form action ="add_latestproduct.php" method="POST">
          <button type="submit" name ="Add_lattest_product" class="login_btn"> <h3>Add Product</h3></button> 
          </form>
      </div>
      <?php 
       $limit = 7;
       ...
       $offset = ($page-1)* $limit;
        $sql = "SELECT*FROM latest_product LIMIT {$offset},{$limit}";
      ...
      <table>
            ...
            <?php
             ...
             <tr>
                ...
                <!-- <td>Null</td>-->
                <td><a href="delete-data.php?lattest-id=<?php echo $row['id'] ?>"><i class="far fa-trash-alt"></i></a></td>
              </tr>
              <?php } ?>
          ...
          echo ' <div class=" container">';
           ...
           for($i=1;  $i<=$tolal_page; $i++) {
              ...
              echo '  <span class=" '.$active.'">
                <a href="admin_lattest_product.php?page='.$i.'">'.$i.'</a>
          </span>'; 
           }
